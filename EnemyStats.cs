...
/// <summary>
/// Base enemy stats. Enemies do not have MP — skills are gated by cooldowns
/// and AI logic. Attach to each enemy prefab alongside StatusEffectHandler and EnemyAI.
/// </summary>
...
public class EnemyStats : MonoBehaviour, ICombatant
{
    ...
    /// <summary>
    /// Reset to full health and clear all status effects.
    /// </summary>
    public void Respawn()
    {
        _currentHP = maxHP;
