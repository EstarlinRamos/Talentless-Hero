...
/// <summary>
/// Inventory page UI with paginated slots, bracket selection, and contextual actions.
/// 
/// SETUP:
/// 1. Create a panel with 9 InventorySlotUI children (3x3 grid recommended)
/// 2. Add forward/back arrow buttons
/// 3. Add an action panel with Use/Equip/Discard buttons
...
public class InventoryPageUI : MonoBehaviour
{
    ...
    private int selectedSlotIndex = -1; // -1 = nothing selected
    ...
    private void NextPage()
    {
        ...
        // Only advance if the next page actually has items
    ...
    private void SelectSlot(int localSlotIndex)
    {
        ...
        // Deselect if tapping the same slot or an empty one
    ...
    private void ConfigureActionButtons(ItemDefinition def, int globalIndex)
    {
        ...
        // Discard button - hidden for quest items
        if (discardButton != null)
